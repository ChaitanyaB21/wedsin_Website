        ...
        <React.Fragment>
            <div className={styles.container}>
                ...
                <p className={styles.paragraph}>
                    Our principle is straightforward: gaining a deeper understanding of oneself helps to create healthier <br /> and happier relationships. Drawing upon ancient religious scriptures and scientific data, we offer meaningful insights to <br /> accompany you on this transformative journey.
                </p>
